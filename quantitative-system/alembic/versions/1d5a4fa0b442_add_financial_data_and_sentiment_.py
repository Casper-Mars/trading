...
down_revision: str | Sequence[str] | None = "8518750f9dbe"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column(
            "cache_key", sqlmodel.sql.sqltypes.AutoString(length=200), nullable=False
        ),
        sa.Column("symbol", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=True),
        sa.Column(
            "data_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column(
            "time_frame",
            sa.Enum(
    ...
    op.create_index(
        "idx_cache_data_type", "market_data_cache", ["data_type"], unique=False
    )
    op.create_index(
        "idx_cache_expires_at", "market_data_cache", ["expires_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "CLOSED", "SUSPENDED", name="positionstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "model_version", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
    ...
    op.create_index(
        "idx_sentiment_content_type",
        "sentiment_analysis",
        ["content_type"],
        unique=False,
    )
    op.create_index(
        "idx_sentiment_created_at", "sentiment_analysis", ["created_at"], unique=False
    )
    op.create_index(
        "idx_sentiment_label", "sentiment_analysis", ["sentiment_label"], unique=False
    )
    op.create_index(
        "idx_sentiment_news_id", "sentiment_analysis", ["news_id"], unique=False
    )
    op.create_index(
        "idx_sentiment_score", "sentiment_analysis", ["sentiment_score"], unique=False
    )
    op.create_table(
        "stock_basic_info",
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "user_id", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column("execution_time", sa.Numeric(precision=10, scale=6), nullable=True),
        sa.Column(
            "created_by", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column(
            "plan_type",
            sa.Enum("MANUAL", "AUTO", "HYBRID", name="plantype"),
            nullable=False,
        ),
        sa.Column(
            "risk_level",
        ...
        sa.Column(
            "max_drawdown_limit", sa.Numeric(precision=8, scale=4), nullable=True
        ),
        ...
        sa.Column(
            "status",
            sa.Enum(
                "DRAFT", "ACTIVE", "PAUSED", "COMPLETED", "CANCELLED", name="planstatus"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_trading_plans_date", "trading_plans", ["plan_date"], unique=False
    )
    op.create_index(
        "idx_trading_plans_status", "trading_plans", ["status"], unique=False
    )
    op.create_index(
        "idx_trading_plans_type", "trading_plans", ["plan_type"], unique=False
    )
    ...
    op.add_column(
        "financial_data",
        sa.Column("int_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("prem_earned", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("comm_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("n_commis_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("n_oth_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("n_oth_b_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("prem_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("out_prem", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("une_prem_reser", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("reins_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("n_sec_tb_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("n_sec_uw_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "n_asset_mg_income", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column("oth_b_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "fv_value_chg_gain", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column("invest_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "ass_invest_income", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column("forex_gain", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
    ...
    op.add_column(
        "financial_data",
        sa.Column("int_exp", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("comm_exp", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("biz_tax_surchg", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
    ...
    op.add_column(
        "financial_data",
        sa.Column(
            "assets_impair_loss", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column("prem_refund", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("compens_payout", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("reser_insur_liab", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("div_payt", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("reins_exp", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("oper_exp", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "compens_payout_refu", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column("insur_reser_refu", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "reins_cost_refund", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column("other_bus_cost", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("non_oper_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("non_oper_exp", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("nca_disploss", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
    ...
    op.add_column(
        "financial_data",
        sa.Column("minority_gain", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("oth_compr_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("t_compr_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("compr_inc_attr_p", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "compr_inc_attr_m_s", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column("insurance_exp", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("undist_profit", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("distable_profit", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
    ...
    op.add_column(
        "financial_data",
        sa.Column("fin_exp_int_exp", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("fin_exp_int_inc", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "transfer_surplus_rese", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "transfer_housing_imprest", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column("transfer_oth", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("adj_lossgain", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "withdra_legal_surplus", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "withdra_legal_pubfund", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "withdra_biz_devfund", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "withdra_rese_fund", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column("withdra_oth_ersu", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column("workers_welfare", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "distr_profit_shrhder", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "prfshare_payable_dvd", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "comshare_payable_dvd", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "capit_comstock_div", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "net_after_nr_lp_correct", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column("credit_impa_loss", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column(
    ...
    op.add_column(
        "financial_data",
        sa.Column(
            "oth_impair_loss_assets", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column("total_opcost", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "amodcost_fin_assets", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column("oth_income", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "asset_disp_income", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column(
            "continued_net_profit", sa.Numeric(precision=20, scale=4), nullable=True
        ),
    )
    op.add_column(
        "financial_data",
        sa.Column("end_net_profit", sa.Numeric(precision=20, scale=4), nullable=True),
    )
    op.alter_column(
        "financial_data",
        "id",
    ...
    op.create_index(
        "idx_financial_ann_date", "financial_data", ["ann_date"], unique=False
    )
    op.create_index(
        "idx_financial_end_date", "financial_data", ["end_date"], unique=False
    )
    op.create_index(
        "idx_financial_ts_code", "financial_data", ["ts_code"], unique=False
    )
    op.create_index(
        "idx_financial_ts_code_end_date",
        "financial_data",
        ["ts_code", "end_date"],
        unique=False,
    )
    op.create_unique_constraint(
        "uq_financial_ts_code_end_date_type",
        "financial_data",
        ["ts_code", "end_date", "report_type"],
    )
    op.drop_table_comment("financial_data", existing_comment="财务数据表", schema=None)
    op.alter_column(
        "news_data",
        "id",
        existing_type=mysql.BIGINT(),
    ...
    op.drop_index(
        op.f("ft_title_content"), table_name="news_data", mysql_prefix="FULLTEXT"
    )
    ...
    op.drop_table_comment("news_data", existing_comment="新闻数据表", schema=None)
...
def downgrade() -> None:
    ...
    op.create_table_comment(
        "news_data", "新闻数据表", existing_comment=None, schema=None
    )
    ...
    op.create_index(
        op.f("idx_sentiment_label"), "news_data", ["sentiment_label"], unique=False
    )
    op.create_index(
        op.f("idx_publish_time"), "news_data", ["publish_time"], unique=False
    )
    op.create_index(
        op.f("idx_is_processed"), "news_data", ["is_processed"], unique=False
    )
    ...
    op.create_table_comment(
        "financial_data", "财务数据表", existing_comment=None, schema=None
    )
    op.drop_constraint(
        "uq_financial_ts_code_end_date_type", "financial_data", type_="unique"
    )
    ...
    op.create_table(
        "stocks",
        sa.Column(
            "id", mysql.BIGINT(), autoincrement=True, nullable=False, comment="主键ID"
        ),
        sa.Column(
            "ts_code",
    ...
    op.create_table(
        ...
        sa.Column(
            "open",
            mysql.DECIMAL(precision=10, scale=3),
            nullable=True,
            comment="开盘价",
        ),
        sa.Column(
        ...
        sa.Column(
            "low", mysql.DECIMAL(precision=10, scale=3), nullable=True, comment="最低价"
        ),
        sa.Column(
            "close",
            mysql.DECIMAL(precision=10, scale=3),
        ...
        sa.Column(
            "amount",
            mysql.DECIMAL(precision=20, scale=3),
            nullable=True,
            comment="成交额(千元)",
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "pe", mysql.DECIMAL(precision=8, scale=4), nullable=True, comment="市盈率"
        ),
        sa.Column(
            "pe_ttm",
            mysql.DECIMAL(precision=8, scale=4),
        ...
        sa.Column(
            "pb", mysql.DECIMAL(precision=8, scale=4), nullable=True, comment="市净率"
        ),
        sa.Column(
            "created_at",
            mysql.TIMESTAMP(),
    ...
    op.create_index(
        op.f("uk_trade_date_market_type"),
        "market_data",
        ["trade_date", "market_type"],
        unique=True,
    )
    op.create_index(op.f("idx_trade_date"), "market_data", ["trade_date"], unique=False)
    op.create_index(
        op.f("idx_market_type"), "market_data", ["market_type"], unique=False
    )
    op.create_table(
        "data_tasks",
        sa.Column(
        ...
        sa.Column(
            "task_config", mysql.JSON(), nullable=True, comment="任务配置(JSON格式)"
        ),
        sa.Column(
            "status",
            mysql.VARCHAR(collation="utf8mb4_unicode_ci", length=20),
    ...
    op.create_table(
        ...
        sa.Column(
            "value",
            mysql.DECIMAL(precision=20, scale=6),
            nullable=True,
            comment="指标值",
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("uk_indicator_period_date"),
        "macro_data",
        ["indicator_code", "period_date"],
        unique=True,
    )
    op.create_index(
        op.f("idx_period_date"), "macro_data", ["period_date"], unique=False
    )
    op.create_index(op.f("idx_period"), "macro_data", ["period"], unique=False)
    op.create_index(
        op.f("idx_indicator_code"), "macro_data", ["indicator_code"], unique=False
    )
