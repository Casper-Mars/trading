...
def upgrade() -> None:
    ...
    op.create_table('data_collection_tasks',
    ...
    op.create_index('idx_data_collection_data_source', 'data_collection_tasks', ['data_source'], unique=False)
    op.create_index('idx_data_collection_last_run_at', 'data_collection_tasks', ['last_run_at'], unique=False)
    op.create_index('idx_data_collection_next_run_at', 'data_collection_tasks', ['next_run_at'], unique=False)
    op.create_index('idx_data_collection_status', 'data_collection_tasks', ['status'], unique=False)
    op.create_index('idx_data_collection_task_type', 'data_collection_tasks', ['task_type'], unique=False)
